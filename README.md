# @trial-trl/react-native-image-viewing
...
<p align="center">
  <img src="https://github.com/trial-trl/react-native-image-viewing/blob/master/demo.gif?raw=true" height="480" />
</p>

## Installation

```bash
yarn add @trial-trl/react-native-image-viewing
```

or

```bash
npm install --save @trial-trl/react-native-image-viewing
```

## Usage

```jsx
import ImageView from "@trial-trl/react-native-image-viewing";
...
#### [See Example](https://github.com/trial-trl/react-native-image-viewing/blob/master/example/App.tsx#L62-L80)
